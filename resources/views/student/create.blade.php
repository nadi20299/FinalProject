                    ...
                    <form action="{{ route('student.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input @error('gender') is-invalid @enderror" id="gender"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" name="skills[]" type="checkbox" value="Angular"
                                    id="angular">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" name="skills[]" type="checkbox" value="WebDevelopment"
                                    id="web_development">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" name="skills[]" type="checkbox" value="Server"
                                    id="server">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" name="skills[]" type="checkbox" value=" WebDesign"
                                    id="web_design">
                        ...
                        <div class="mb-3">
                            <label for="is_fullstack">Are You FullStack Developer?</label>
                            <div class="form-check">
                                <input class="form-check-input" name="is_fullstack" type="checkbox" value="1"
                                    id="is_fullstack">
